...
def setupGUI():
    ...
    btn_label.grid(row=2, columnspan=3, padx=3, pady=3)
    flash_btn = Button(btn_label, text='run the FLASH', font='Courier 15 bold', fg='dark blue', command=click_flash, width=30)
    flash_btn.grid(row=0, columnspan=2, padx=5, pady=5)
